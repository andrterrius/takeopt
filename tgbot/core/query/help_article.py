...
async def get_help_articles(bot: Bot, exception_text=""):
    ...
    articles = [
        ...
        description=_("Для создания распределения нужно ввести в строку запроса число вариантов или x y +z,"),
        input_message_content=InputTextMessageContent(
            message_text=bot_username,
            parse_mode="HTML",
            )
        ...
        InlineQueryResultArticle(
            ...
            description=_("{bot_username} 50 - создаст распределение вариантов от 1 до 50, где можно выбрать только 1").format(bot_username=bot_username),
            input_message_content=InputTextMessageContent(
                message_text=bot_username,
                parse_mode="HTML",
            )
        ...
        InlineQueryResultArticle(
            id="help_example_2",
            title=_("Пример создания распределения по диапазону"),
            description=_(
                "{bot_username} 1 50 - создаст распределение вариантов от 1 до 50, где можно выбрать только 1").format(
        ...
        InlineQueryResultArticle(
            ...
            description=_(
                "{bot_username} 10 50 +2 - создаст распределение вариантов от 10 до 50, "
